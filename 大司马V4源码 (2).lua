...
local ui = loadstring(game:HttpGet("https://raw.githubusercontent.com/xiao66778/xGB/refs/heads/main/78UI.lua"))();        
...
about:Toggle("无敌模式","", false, function(Value)
    ...
    local about = UITab59:section("钓鱼模拟器",'16060333448')
